...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-[#1A1E1C]">
      ...
      {/* Desktop Hero */}
      <div className="hidden lg:flex max-w-[1440px] mx-auto px-4 md:px-8 lg:px-32 min-h-screen items-center overflow-x-hidden">
      ...
      {/* Wrap sections after card section */}
      <div className="relative">
        <VideoSection />
        <CardSection />
        <div className="relative z-0"> {/* Add z-index context for sections after card */}
          <ScoreSection />
          <OfferSection />
          <DownloadSection />
          <Footer />
