        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-[1440px] w-full px-4 md:px-8 lg:px-32">
            <div className="flex flex-col lg:flex-row items-center gap-2 lg:gap-12 pt-[80px] lg:pt-0">
              ...
              <div className="lg:w-1/2 h-[200px] lg:h-[625px] flex items-center justify-center relative">
                <div ref={cardsRef} className="relative w-[250px] lg:w-[400px] h-[200px] lg:h-[625px] z-20 mx-auto">
                  {cards.map((card) => (
                    <div
                      key={card.id}
              ...
              <div className="lg:w-1/2 min-h-[300px] h-[calc(60vh-80px)] lg:h-[625px] flex items-start lg:items-center">
                <motion.div 
